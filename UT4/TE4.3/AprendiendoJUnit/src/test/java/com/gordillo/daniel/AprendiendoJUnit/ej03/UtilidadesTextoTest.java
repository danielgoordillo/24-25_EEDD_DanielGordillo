...
class UtilidadesTextoTest {
    ...
    void testEsPalindromo() {
        assertTrue(UtilidadesTexto.esPalindromo("Daniel lava la tina"));
    ...
    void testContarPalabras() {
        ...
        assertEquals(17, UtilidadesTexto.contarPalabras("En un lugar de la Mancha de cuyo nombre no quiero acordarme"));
        assertEquals(10, UtilidadesTexto.contarPalabras("El perro de San Roque no tiene rabo"));
        assertEquals(0, UtilidadesTexto.contarPalabras(" "));
    }
    @Test
    @DisplayName("Test contarCaracteres")
    void testContarCaracteres() {
        assertEquals(10, UtilidadesTexto.contarCaracteres("Hola Mundo"));
        assertEquals(10, UtilidadesTexto.contarCaracteres("Murcielago"));
        assertEquals(70, UtilidadesTexto.contarCaracteres("En un lugar de la Mancha de cuyo nombre no quiero acordarme"));
        assertEquals(38, UtilidadesTexto.contarCaracteres("El perro de San Roque no tiene rabo"));
